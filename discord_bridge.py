...
def transform_text(raw_text: str) -> Optional[str]:
    text = remove_source_header(raw_text)
...
async def handle_channel_post(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    log("Final Discord/Pipedream text:\n", result)

    try:
        send_to_pipedream(result)
...
def main():
    ...
    print("Discord bridge bot started...")
